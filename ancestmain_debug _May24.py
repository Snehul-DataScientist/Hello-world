...
def finalFun(list2):
    ...
    fetchNameslist, Given_Namelist, Surnamelist, Prefixlist, Suffixlist =definition.myName(s4list)  
    # Gensent = bowgen(occupators)
    # Occupationlist = occupant(s4list,Gensent)
    Occupationlist =definition.occupant(s4list)
    Address1,Address2,Sno = definition.address(s4list,Given_Namelist, Surnamelist, Prefixlist,Occupationlist)
    
    
    return fetchNameslist, Given_Namelist, Surnamelist, Prefixlist, Suffixlist, Occupationlist, Address1,Address2, Sno
...
#    path = "/home/ronakshah/Ram/SplitTest"
    ...
    in_dir_path = "/home/ramakrishnabhat/Ram/Ancestery.com/46928/input/OCR-16May2017/Output_Format_2/solve/"
    out_dir_path = "/home/ramakrishnabhat/Ram/Ancestery.com/46928/input/OCR-16May2017/Output_Format_2/output/"
    ...
    for output in txtfiles:
        ...
        Names, Given_Name, Surname, Prefix, Suffix, Occupation, Address1,Address2, Sno = finalFun(list2) #function_call
        ...
        dt = dt.split(' ')[0]
            # print (result)
	result.to_csv(out_dir_path+dt+os.path.basename(output)+"_output.csv", encoding='utf-8', index=False, columns=nameslist)
